...
export const blogPosts: Record<string, BlogPost> = {
  "beneficios-terapia-individual": {
    ...
    seoDescription: "Descubre por qué la terapia individual funciona para la ansiedad, la autoestima y el bienestar emocional. Psicóloga en Córdoba con amplia experiencia.",
  ...
  "gestion-ansiedad": {
    ...
    seoDescription: "La ansiedad no es debilidad. Técnicas psicológicas para gestionar la ansiedad en el día a día. Por psicóloga en Córdoba.",
